...
select_var = st.sidebar.selectbox("Select a model", ["Home", "Iris Species"])

def iris():
    st.write("# Welcome To Iris App")
    st.write("""
    This app predicts the **Iris Species**
    
    Copyright 2025 Raihan Pratama
    ...
    st.image("https://www.easytogrowbulbs.com/cdn/shop/products/BeardedIrisColorfullMix_VIS-sqWeb_8a293612-7bc0-4a9f-89ac-917e820d0ccb.jpg?v=1664472481&width=1920", width=400)
    ...
    if button_var:
        ...
        with open("generate_iris.pkl", 'rb') as file:  
            loaded_model = pkl.load(file) # load previous trained model
